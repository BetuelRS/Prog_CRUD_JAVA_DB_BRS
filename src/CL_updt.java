...
public class CL_updt extends javax.swing.JFrame {
    ...
    // --- Código (obrigatório e numérico) ---
    if (txtCodId.getText().trim().isEmpty()) {
        erro += "- Código do cliente é obrigatório.\n";
    } else {
        try {
            Integer.parseInt(txtCodId.getText().trim());
        } catch (NumberFormatException e) {
            erro += "- Código do cliente deve ser um número inteiro.\n";
        }
    }
